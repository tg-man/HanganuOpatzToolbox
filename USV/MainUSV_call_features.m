...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%         align timestamps to click release (ephys starts on release)
%         before always aligned to down click 
%         Calls.Box(:, 1) = Calls.Box(:, 1) - Calls.Box(1, 1); % adjust timestamps to align to click down (on ephys GUI)
        Calls.Box(:, 1) = Calls.Box(:, 1) - (Calls.Box(1, 1) + Calls.Box(1, 3)); % alternative way of timestamps adjustment, align to click release (on ephys GUI) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
