...
x = unique(age);
for i = 1 : numel(x)
    y(i, :) = nanmedian(time_in_osc(age == x(i), :), 1);
...
xlabel('Age (P)'); ylabel('Frac. Time Active'); set(gca, 'FontSize', 16, 'FontName', 'Arial', 'LineWidth', 2, 'TickDir', 'out'); 
xlim([4.5 12.5]); ylim([0 1.05]);
...
xlabel('Age (P)'); ylabel('Active periods/min'); set(gca, 'FontSize', 18, 'FontName', 'Arial', 'LineWidth', 2, 'TickDir', 'out'); xlim([0 9]); ylim([0 16]);
title('Str','FontSize', 18, 'FontName', 'Arial', 'FontWeight', 'normal');
...
xlabel('Age (P)'); ylabel('Active periods/min'); set(gca, 'FontSize', 16, 'FontName', 'Arial', 'LineWidth', 2, 'TickDir', 'out'); xlim([0 9]); ylim([0 16]);
title('TH', 'FontSize', 16, 'FontName', 'Arial');
...
xlabel('Age (P)'); ylabel('Duration (s)'); set(gca, 'FontSize', 16, 'FontName', 'Arial', 'LineWidth', 2, 'TickDir', 'out'); 
...
xlabel('Age (P)'); ylabel('Duration (s)'); set(gca, 'FontSize', 16, 'FontName', 'Arial', 'LineWidth', 2, 'TickDir', 'out'); 
set(gca, 'YScale', 'log'); xlim([0 9]); ylim([0 1000]);
...
x = unique(age);
for i = 1 : numel(x)
    y(i, :) = nanmedian(duration(age == x(i), :), 1);
    s(i, :) = nanstd(duration(age == x(i), :), 1) ./ sqrt(sum(age == x(i)));
end 
figure; hold on; 
...
xlabel('Age (P)'); ylabel('Duration (s)'); set(gca, 'FontSize', 16, 'FontName', 'Arial', 'LineWidth', 2, 'TickDir', 'out'); 
xlim([4.5 12.5]); set(gca, 'YScale', 'log')
...
xlabel('Age (P)'); ylabel('Amplitude (\muV)'); set(gca, 'FontSize', 16, 'FontName', 'Arial', 'LineWidth', 2, 'TickDir', 'out')
...
% set(gca, 'YScale', 'log', 'FontSize', 16, 'LineWidth', 2, 'TickDir', 'out');
% title('ACC', 'FontSize', 16, 'FontName', 'Arial');
% 
...
for idx = 1:size(PowerPlotTH)
    plot(freqs, PowerPlotTH(idx,:), 'LineWidth', 2, 'Color', Greens(round(100/8*idx),:)); 
%     boundedline(PSDstruct.freqs, PowerPlotPFC(idx,:), shading1(idx,:), 'cmap', YlGnBu(round(100/8*idx),:));   
end 
ylabel('Power (\muV^2)'); xlabel('Frequency (Hz)'); xlim([1 50]); ylim([0.01 30]);
